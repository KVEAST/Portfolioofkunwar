...
(function($) {
    ...
    burgerMenu();
    var onePageClick = function() { $(document).on('click', '#ftco-nav a[href^="#"]', function(event) { event.preventDefault(); var href = $.attr(this, 'href');
    ...
    carousel();
    $('nav .dropdown').hover(function() { var $this = $(this);
        $this.addClass('show');
        $this.find('> a').attr('aria-expanded', true);
        $this.find('.dropdown-menu').addClass('show'); }, function() { var $this = $(this);
    ...
    var scrollWindow = function() {
        $(window).scroll(function() {
            ...
            if (st < 350) {
                if (navbar.hasClass('awake')) { navbar.removeClass('awake');
    ...
    var counter = function() {
        $('#section-counter, .hero-wrap, .ftco-counter, .ftco-about').waypoint(function(direction) {
            if (direction === 'down' && !$(this.element).hasClass('ftco-animated')) {
                ...
                $('.number').each(function() { var $this = $(this),
    ...
    var goHere = function() { $('.mouse-icon').on('click', function(event) { event.preventDefault();
            $('html,body').animate({ scrollTop: $('.goto-here').offset().top }, 500, 'easeInOutExpo'); return false; }); };
    goHere();
    var TxtRotate = function(el, toRotate, period) { this.toRotate = toRotate;
        this.el = el;
        this.loopNum = 0;
...
(function($) {
    ...
    var id = false;
    var $navbara = $('#navi a');
    $navbara.click(function(e) { e.preventDefault();
    ...
    $(window).scroll(function(e) {
        ...
        if (scrolled_id !== id) { id = scrolled_id;
